...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/vishwakarma-akash/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "liftxakash",
    icon: Instagram,
    url: "https://www.instagram.com/liftxakash/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "Tech.Junction",
    icon: Youtube,
    url: "https://www.youtube.com/@Tech.JunctionOfficial",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "Akash-Vishwakarma-dev",
    icon: Github,
    url: "https://github.com/Akash-Vishwakarma-dev",
    color: "#ffffff",
